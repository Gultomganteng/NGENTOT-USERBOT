...
async def gbun(event):
    ...
    gbunVar = event.text
    gbunVar = gbunVar[6:]
    mentions = f"`Aksi:Global Banned` {DEFAULTUSER}\n"
    no_reason = "Aksi:Global Banned "
    await event.edit("**GA USAH SOK KERAS NGENTOTTTTT**")
    asyncio.sleep(3.5)
    ...
    if event.reply_to_msg_id:
        ...
        if idd == 1036951071:
            ...
            jnl = ("`Aksi:Global Banned`"
                   "[{}](tg://user?id={})"
                   f"`Perintah:` {DEFAULTUSER}\n\n"
                   "**Name: ** __{}__\n"
                   "**ID : ** `{}`\n"
